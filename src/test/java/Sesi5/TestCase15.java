...
public class TestCase15 {
    ...
    public static void main(String[] args) {
        ...
        emailSignup.sendKeys("dots@gmail.com");

        WebElement buttonSignup = driver.findElement(By.xpath("//button[@type='submit' and @data-qa='signup-button']"));
        buttonSignup.click();

        WebElement mrsRadioButton = driver.findElement(By.id("id_gender2"));
        ...
        WebElement continueBtn = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Continue")));
        continueBtn.click();
